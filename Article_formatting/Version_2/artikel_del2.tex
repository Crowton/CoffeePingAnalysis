...
\begin{figure*}[t!]
	\centering
	\resizebox{2\columnwidth}{!}{\input{Version_2/plot_weekday_analysis_hour_imposed_2022-2023_2023-2024.pgf}}
	\vspace{-10pt}
...
\begin{figure*}[t!]
	...
	\begin{tabularx}{2\columnwidth}{MMM}
		\resizebox{.60\columnwidth}{!}{\input{Version_2/plot_pair_relation_norm_by_max_pair_weight.pgf}}
		&
		\resizebox{.60\columnwidth}{!}{\input{Version_2/plot_pair_relation_norm_by_person_group_count.pgf}}
		&
		\resizebox{.60\columnwidth}{!}{\input{Version_2/plot_pair_relation_norm_by_person_max_pair_count.pgf}}
		\\
