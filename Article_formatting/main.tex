...
\newcommand*\inlinegraphics[1]{%
  \settototalheight\myheight{Xygp}%
  \settodepth\mydepth{Xygp}%
  \raisebox{-0.66\mydepth}{\includegraphics[height=\myheight]{#1}}%
}
...
% Coffee analysis
\input{Version_1/artikel}

\input{Version_2/artikel}
\input{Version_2/artikel_del1}
\input{Version_2/artikel_del2}

\input{Version_3/artikel}
