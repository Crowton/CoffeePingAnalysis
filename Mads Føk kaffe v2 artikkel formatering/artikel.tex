...
\begin{figure*}[t!]
	...
	\begin{tabularx}{2\columnwidth}{MMM}
		\resizebox{.64\columnwidth}{!}{\input{plot_pair_relation_norm_by_max_pair_weight.pgf}}
		&
		\resizebox{.64\columnwidth}{!}{\input{plot_pair_relation_norm_by_person_group_count.pgf}}
		&
		\resizebox{.64\columnwidth}{!}{\input{plot_pair_relation_norm_by_person_max_pair_count.pgf}}
		\\
